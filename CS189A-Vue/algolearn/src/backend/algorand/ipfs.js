...
const nftWorkspacePath = __dirname + '/src/images';
...
const scenario1 = async (nftFile, nftFileName, assetName, assetDesc) => {
  ...
  console.log("Arrive at pinfileToIPFS")
...
const createNftScenario1 = async () => {
  return await pinata.testAuthentication().then((res) => {
    ...
    let nftFileName = 'pexels-photo-674010.jpeg'
    fetch('https://images-ext-2.discordapp.net/external/VzOaSzoH9n-Gc4TJcKowpnjW_9uq5gfkkUcILy48DOM/%3Fauto%3Dcompress%26cs%3Dtinysrgb%26w%3D1260%26h%3D750%26dpr%3D2/https/images.pexels.com/photos/674010/pexels-photo-674010.jpeg?width=496&height=663')
.then(response=> {
   const reader = response.body.getReader()
   return scenario1(reader, nftFileName, 'NFT::ARC3::IPFS::1', 'This is a Scenario1 NFT created with metadata JSON in ARC3 compliance and using IPFS via Pinata API')

})

    //  const sampleNftFile = fetch('https://images-ext-2.discordapp.net/external/VzOaSzoH9n-Gc4TJcKowpnjW_9uq5gfkkUcILy48DOM/%3Fauto%3Dcompress%26cs%3Dtinysrgb%26w%3D1260%26h%3D750%26dpr%3D2/https/images.pexels.com/photos/674010/pexels-photo-674010.jpeg?width=496&height=663');
