                          ...
                          child: Row(
                            ...
                            children: [
                              courseButton(
                                  ...
                                  nftOwned: "7 nft owned",
                                  width: width,
                                  height: height),
                              courseButton(
                                  name: 'CS165A',
                                  description: "Intro to AI",
                                  nftOwned: "10 nft owned",
                                  width: width,
                                  height: height),
                              courseButton(
                                  name: "CS181",
                                  description: "Computer Vision",
                                  nftOwned: "5 nft owned",
                                  width: width,
                                  height: height),
                              courseButton(
                                  name: 'CS160',
                                  description: 'Transfer to compiling language',
                                  nftOwned: '6 nftOwned',
                                  width: width,
                                  height: height)
                            ],
